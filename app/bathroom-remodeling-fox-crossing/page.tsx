...
export const metadata: Metadata = {
  title: "Bathroom Remodeling Fox Crossing Chandler AZ",
  description: "Expert bathroom remodeling in Fox Crossing, Chandler. Licensed contractors serving this established neighborhood. Free estimates today.",
  alternates: {
    canonical: `${siteConfig.url}/bathroom-remodeling-fox-crossing`,
  },
};

const areaData = bathroomRemodelingAreas["fox-crossing"];
...
export default function FoxCrossingBathroomRemodelingPage() {
  const breadcrumbs = [
    { name: "Home", url: siteConfig.url },
    { name: "Bathroom Remodeling", url: `${siteConfig.url}/bathroom-remodeling` },
    { name: "Fox Crossing", url: `${siteConfig.url}/bathroom-remodeling-fox-crossing` },
  ];
  ...
  return (
    <>
      <ServiceSchema serviceName={areaData.fullName} serviceDescription={`Professional bathroom remodeling services in ${areaData.areaName}, Chandler. ${areaData.description}`} serviceUrl={`${siteConfig.url}/bathroom-remodeling-fox-crossing`} />
