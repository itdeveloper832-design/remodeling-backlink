...
export const metadata: Metadata = {
  ...
  description: "Expert bathroom remodeling in Sun Lakes, Chandler. Licensed contractors serving this 55+ community. Free estimates today.",
  alternates: {
    canonical: `${siteConfig.url}/bathroom-remodeling-sun-lakes`,
  },
};

const areaData = bathroomRemodelingAreas["sun-lakes"];
  ...
  return (
    <>
      <ServiceSchema
        ...
        serviceDescription={`Professional bathroom remodeling services in ${areaData.areaName}, Chandler. ${areaData.description}`}
        serviceUrl={`${siteConfig.url}/bathroom-remodeling-${areaData.areaSlug}`}
      />
