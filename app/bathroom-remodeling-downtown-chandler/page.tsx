...
export const metadata: Metadata = {
  title: "Bathroom Remodeling Downtown Chandler AZ",
  description: "Expert bathroom remodeling in Downtown Chandler. Licensed contractors serving this vibrant area. Free estimates today.",
  alternates: {
...
export default function DowntownChandlerBathroomRemodelingPage() {
  const breadcrumbs = [
    { name: "Home", url: siteConfig.url },
    { name: "Bathroom Remodeling", url: `${siteConfig.url}/bathroom-remodeling` },
    { name: "Downtown Chandler", url: `${siteConfig.url}/bathroom-remodeling-downtown-chandler` },
  ];
  ...
  return (
    <>
      <ServiceSchema serviceName={areaData.fullName} serviceDescription={`Professional bathroom remodeling services in ${areaData.areaName}, Chandler. ${areaData.description}`} serviceUrl={`${siteConfig.url}/bathroom-remodeling-downtown-chandler`} />
